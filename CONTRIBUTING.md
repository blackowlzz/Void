...
Thank you for your interest in contributing to Void. This document outlines the guidelines for
making pull
...
- Void is built using [Gradle](https://gradle.org/) kotlin scripts.
