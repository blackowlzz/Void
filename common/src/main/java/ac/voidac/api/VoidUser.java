...
import ac.voidac.api.handler.UserHandlerHolder;
import org.jetbrains.annotations.Nullable;

import java.util.Collection;
import java.util.UUID;

public interface VoidUser extends ConfigReloadable, BasicReloadable, UserHandlerHolder, VoidIdentity {
     ...
     * This needs to be executed on the player's netty thread. You can use {@link VoidUser#runSafely(Runnable)} to ensure this.
     *
