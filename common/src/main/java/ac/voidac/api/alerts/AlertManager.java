...
public interface AlertManager {
     ...
     * @throws NullPointerException if player is null
     */
    default boolean toggleAlerts(@NonNull VoidUser player, boolean silent) {
     ...
     * Sends a message to the player indicating the new state.
     *
     * @param player The VoidUser to set alerts for
     * @param enabled true to enable alerts, false to disable
     * @throws NullPointerException if player is null
     */
    default void setAlertsEnabled(@NonNull VoidUser player, boolean enabled) {
     ...
     * @throws NullPointerException if player is null
     */
    void setAlertsEnabled(@NonNull VoidUser player, boolean enabled, boolean silent);
     ...
     * @throws NullPointerException if player is null
     */
    boolean hasVerboseEnabled(@NonNull VoidUser player);

    /**
     * Toggles verbose for the player.
     * Sends a message to the player indicating the new state.
     *
     * @param player The VoidUser to toggle verbose for
     * @return true if verbose is now enabled, false if verbose is now disabled
     * @throws NullPointerException if player is null
     */
    default boolean toggleVerbose(@NonNull VoidUser player) {
     ...
     * @throws NullPointerException if player is null
     */
    default boolean toggleVerbose(@NonNull VoidUser player, boolean silent) {
     ...
     * Sends a message to the player indicating the new state.
     *
     * @param player The VoidUser to set verbose for
     * @param enabled true to enable verbose, false to disable
     * @throws NullPointerException if player is null
     */
    default void setVerboseEnabled(@NonNull VoidUser player, boolean enabled) {
     ...
     * @throws NullPointerException if player is null
     */
    void setVerboseEnabled(@NonNull VoidUser player, boolean enabled, boolean silent);
     ...
     *
     * @param player The VoidUser to check
     * @return true if the player has brand notifications enabled and has the "void.brand" permission,
     *         false otherwise
     * @throws NullPointerException if player is null
     */
    boolean hasBrandsEnabled(@NonNull VoidUser player);

    /**
     * Toggles brand notifications for the player.
     * Sends a message to the player indicating the new state.
     *
     * @param player The VoidUser to toggle brand notifications for
     * @return true if brand notifications are now enabled, false if brand notifications are now disabled
     * @throws NullPointerException if player is null
     */
    default boolean toggleBrands(@NonNull VoidUser player) {
     ...
     * @throws NullPointerException if player is null
     */
    default boolean toggleBrands(@NonNull VoidUser player, boolean silent) {
     ...
     * Sends a message to the player indicating the new state.
     *
     * @param player The VoidUser to set brand notifications for
     * @param enabled true to enable brand notifications, false to disable
     * @throws NullPointerException if player is null
     */
    default void setBrandsEnabled(@NonNull VoidUser player, boolean enabled) {
     ...
     * @throws NullPointerException if player is null
     */
    void setBrandsEnabled(@NonNull VoidUser player, boolean enabled, boolean silent);
