package ac.voidac.api.storage.event;

import ac.voidac.api.storage.model.ReplayClip;
...
public final class SessionEvent {
    ...
    private @Nullable String voidVersion;
    ...
    public @Nullable String voidVersion() { return voidVersion; }
    public @NotNull SessionEvent voidVersion(@Nullable String v) { this.voidVersion = v; return this; }
