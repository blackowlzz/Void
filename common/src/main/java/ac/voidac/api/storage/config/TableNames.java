package ac.voidac.api.storage.config;
 ...
 * <p>
 * Lives as a field on each concrete {@link ac.voidac.api.storage.backend.BackendConfig}
 * so an operator can rename any of them (to share a DB with another plugin, to
 * match a corporate naming scheme, to keep two Void instances side-by-side in
 ...
 *       table name. Defaults are {@code void_meta}, {@code void_checks},
 *       {@code void_players}, {@code void_sessions}, {@code void_violations},
 *       {@code void_settings}.</li>
 ...
 *       building keys (e.g. {@code void_violations:<sessionId>}). Operators
 *       who prefer colon-namespaced Redis keys can set values like
 *       {@code void:violations}; nothing in this record forbids colons.</li>
 * </ul>
 * <p>
 ...
 * collections / keys first, or run {@code /void history copy} from a backend
...
public record TableNames(
    ...
    public static final String DEFAULT_META = "void_meta";
    public static final String DEFAULT_CHECKS = "void_checks";
    public static final String DEFAULT_PLAYERS = "void_players";
    public static final String DEFAULT_SESSIONS = "void_sessions";
    ...
    /**
     * Read the six names from a {@link ac.voidac.api.storage.backend.BackendConfigSource}
    ...
    public static @NotNull TableNames readFrom(
            @NotNull ac.voidac.api.storage.backend.BackendConfigSource source) {
