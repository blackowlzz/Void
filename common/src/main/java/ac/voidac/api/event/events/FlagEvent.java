...
public class FlagEvent extends VoidVerboseCheckEvent<FlagEvent.Channel> {
    ...
    public FlagEvent(VoidUser user, AbstractCheck check, String verbose) {
        super(user, check, verbose);
    }

    @ApiStatus.Internal
    @Override
    public void init(VoidUser user, AbstractCheck check, String verbose) {
    ...
    public interface Handler {
        boolean onFlag(@NotNull VoidUser user, @NotNull AbstractCheck check,
    ...
    public static final class Channel extends EventChannel<FlagEvent, Handler> {
        ...
        public void onFlag(@NotNull VoidPlugin plugin, @NotNull Handler handler) {
            subscribe(handler, 0, false, plugin, null);
        }

        public void onFlag(@NotNull VoidPlugin plugin, @NotNull Handler handler, int priority) {
            subscribe(handler, priority, false, plugin, null);
        }

        public void onFlag(@NotNull VoidPlugin plugin, @NotNull Handler handler, int priority, boolean ignoreCancelled) {
        ...
        public boolean fire(@NotNull VoidUser user, @NotNull AbstractCheck check, @NotNull String verbose) {
        ...
        /** Bridge from {@link VoidVerboseCheckEvent.Handler}. */
        @ApiStatus.Internal
