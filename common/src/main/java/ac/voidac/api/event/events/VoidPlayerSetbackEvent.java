...
public final class VoidPlayerSetbackEvent extends VoidSetbackEvent<VoidPlayerSetbackEvent.Channel> {
    ...
    public interface Handler {
        void onPlayerSetback(@NotNull VoidUser user, int teleportId,
                             double x, double y, double z, long timestamp);
    }

    public static final class Channel extends EventChannel<VoidPlayerSetbackEvent, Handler> {
        public Channel() {
            super(VoidPlayerSetbackEvent.class, Handler.class);
        }

        public void onPlayerSetback(@NotNull VoidPlugin plugin, @NotNull Handler handler) {
            subscribe(handler, 0, false, plugin, null);
        }

        public void onPlayerSetback(@NotNull VoidPlugin plugin, @NotNull Handler handler, int priority) {
        ...
        public void fire(@NotNull VoidUser user, int teleportId,
                         double x, double y, double z, long timestamp) {
        ...
        public static @NotNull Handler bridgeFromAny(@NotNull ac.voidac.api.event.VoidEvent.Handler abstractHandler) {
            return (user, id, x, y, z, ts) -> abstractHandler.onAnyEvent(VoidPlayerSetbackEvent.class, false);
        }
    }
}
