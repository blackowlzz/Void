 ...
 */
public abstract class EventChannel<E extends VoidEvent<?>, H> {
     ...
     * Fabric {@code ModContainer}, …) into a {@link VoidPlugin}. Used by the
     * deprecated {@code onX(Object ctx, Handler)} overloads on each
     * subclass so plugin authors that don't have a {@code VoidPlugin} handy
     ...
     */
    @ApiStatus.Internal
    protected final @NotNull VoidPlugin resolvePlugin(@NotNull Object pluginContext) {
        if (pluginContext instanceof VoidPlugin) return (VoidPlugin) pluginContext;
        PluginResolver r = this.pluginResolver;
        if (r == null) {
            throw new IllegalStateException("EventChannel " + eventClass.getSimpleName()
                    + " has no plugin resolver installed; pass a VoidPlugin directly instead of a platform-specific context.");
        }
    ...
    public interface PluginResolver {
        @NotNull VoidPlugin resolve(@NotNull Object pluginContext);
    }
    ...
    /**
     * Internal: registers a legacy {@link VoidEventListener} on this channel's
     * legacy slot. Invoked by the bus when a caller uses the deprecated
     * class-keyed subscribe to bridge into the channel.
     */
    @ApiStatus.Internal
    public final <GE extends VoidEvent<?>> void subscribeLegacy(
            @NotNull VoidEventListener<GE> listener,
    ...
    @ApiStatus.Internal
    public final void unsubscribeLegacy(@NotNull VoidEventListener<?> listener) {
        ...
        for (Entry<H> e : arr) {
            ...
            try {
                if (e.legacyListener != null) {
                    ...
                    @SuppressWarnings("unchecked")
                    VoidEventListener<E> listener = (VoidEventListener<E>) e.legacyListener;
     ...
     * return {@code false}.
     *
     * <p>Only invoked via {@link #dispatchLegacy(VoidEvent)}. The hot-path
    ...
    public static final class Entry<H> {
        ...
        public final @Nullable VoidEventListener<? extends VoidEvent<?>> legacyListener;
        public final @Nullable Class<? extends VoidEvent<?>> legacyEventClass;
        ...
        Entry(@Nullable H handler,
              @Nullable VoidEventListener<? extends VoidEvent<?>> legacyListener,
              @Nullable Class<? extends VoidEvent<?>> legacyEventClass,
              int priority, boolean ignoreCancelled,
              @Nullable Object pluginContext, @Nullable Class<?> declaringClass) {
        ...
        @SuppressWarnings("unchecked")
        public <GE extends VoidEvent<?>> @NotNull VoidEventListener<GE> legacyListenerAs() {
            return (VoidEventListener<GE>) legacyListener;
        }
    }
}
