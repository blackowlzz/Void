 ...
 * <pre>{@code
 * // Subscribe
 * EventBus bus = VoidAPIProvider.getAPI().getEventBus();
 ...
 *     VoidAPI.INSTANCE.getEventBus().get(FlagEvent.class);
...
public interface EventBus {
     ...
     * @param <C>        the channel subclass associated with {@code E}, inferred via {@code E extends VoidEvent<C>}
     */
    <E extends VoidEvent<C>, C extends EventChannel<? extends E, ?>> @NotNull C get(@NotNull Class<E> eventClass);

    /**
     * Registers a channel for an event type not known at bus construction
     * time. Addons that define their own {@link VoidEvent} subclass with a
     ...
     */
    <E extends VoidEvent<C>, C extends EventChannel<? extends E, ?>> void register(@NotNull Class<E> eventClass, @NotNull C channel);
     ...
     * event instance, and the indirection through {@link VoidEventListener}.
     ...
     */
    @Deprecated
    void registerAnnotatedListeners(@NotNull VoidPlugin plugin, @NotNull Object listener);
     ...
     */
    @Deprecated
    void registerStaticAnnotatedListeners(@NotNull VoidPlugin plugin, @NotNull Class<?> clazz);
     ...
     */
    @Deprecated
    void unregisterListeners(@NotNull VoidPlugin plugin, @NotNull Object listener);
     ...
     */
    void unregisterAllListeners(@NotNull VoidPlugin plugin);

    /**
     * @deprecated See {@link #unregisterListeners(Object, Object)}.
     */
    @Deprecated
    void unregisterListener(@NotNull Object pluginContext, @NotNull VoidEventListener<?> listener);

    /**
     * @deprecated See {@link #unregisterListener(Object, VoidEventListener)}.
     */
    @Deprecated
    void unregisterListener(@NotNull VoidPlugin plugin, @NotNull VoidEventListener<?> listener);
     ...
     */
    @Deprecated
    <T extends VoidEvent<?>> void subscribe(@NotNull Object pluginContext, @NotNull Class<T> eventType, @NotNull VoidEventListener<T> listener, int priority, boolean ignoreCancelled, @NotNull Class<?> declaringClass);

    /**
     * @deprecated See {@link #subscribe(Object, Class, VoidEventListener, int, boolean, Class)}.
     */
    @Deprecated
    <T extends VoidEvent<?>> void subscribe(@NotNull VoidPlugin plugin, @NotNull Class<T> eventType, @NotNull VoidEventListener<T> listener, int priority, boolean ignoreCancelled, @NotNull Class<?> declaringClass);

    /**
     * @deprecated See {@link #subscribe(Object, Class, VoidEventListener, int, boolean, Class)}.
     */
    @Deprecated
    default <T extends VoidEvent<?>> void subscribe(@NotNull Object pluginContext, @NotNull Class<T> eventType, @NotNull VoidEventListener<T> listener, int priority, boolean ignoreCancelled) {
     ...
     */
    @Deprecated
    default <T extends VoidEvent<?>> void subscribe(@NotNull VoidPlugin plugin, @NotNull Class<T> eventType, @NotNull VoidEventListener<T> listener, int priority, boolean ignoreCancelled) {
     ...
     */
    @Deprecated
    default <T extends VoidEvent<?>> void subscribe(@NotNull Object pluginContext, @NotNull Class<T> eventType, @NotNull VoidEventListener<T> listener) {
     ...
     */
    @Deprecated
    default <T extends VoidEvent<?>> void subscribe(@NotNull VoidPlugin plugin, @NotNull Class<T> eventType, @NotNull VoidEventListener<T> listener) {
