...
import ac.voidac.utils.collisions.AxisUtil;
...
public class ConsumesBlockPlace {
    public static boolean consumesPlace(@NotNull VoidPlayer player, @NotNull WrappedBlockState state, @NotNull BlockPlace place) {
