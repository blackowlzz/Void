package ac.voidac.utils.collisions;
...
import ac.voidac.utils.collisions.blocks.DynamicChest;
import ac.voidac.utils.collisions.blocks.DynamicChorusPlant;
import ac.voidac.utils.collisions.blocks.DynamicStair;
import ac.voidac.utils.collisions.blocks.PistonBaseCollision;
import ac.voidac.utils.collisions.blocks.PistonHeadCollision;
import ac.voidac.utils.collisions.blocks.TrapDoorHandler;
import ac.voidac.utils.collisions.blocks.connecting.DynamicCollisionFence;
import ac.voidac.utils.collisions.blocks.connecting.DynamicCollisionPane;
import ac.voidac.utils.collisions.blocks.connecting.DynamicCollisionWall;
import ac.voidac.utils.collisions.datatypes.CollisionBox;
import ac.voidac.utils.collisions.datatypes.CollisionFactory;
import ac.voidac.utils.collisions.datatypes.ComplexCollisionBox;
import ac.voidac.utils.collisions.datatypes.DynamicCollisionBox;
import ac.voidac.utils.collisions.datatypes.HexCollisionBox;
import ac.voidac.utils.collisions.datatypes.HexOffsetCollisionBox;
...
public enum CollisionData implements CollisionFactory {
    ...
    public static CollisionData getData(StateType state) {
        // noCollision() blocks that still have hitboxes (PITCHER_CROP, lava, scaffolding)
    ...
    public CollisionBox getMovementCollisionBox(VoidPlayer player, ClientVersion version, WrappedBlockState block, int x, int y, int z) {
        return fetch(player, version, block, x, y, z).offset(x, y, z);
    }

    public CollisionBox getMovementCollisionBox(VoidPlayer player, ClientVersion version, WrappedBlockState block) {
        if (this.box != null)
    ...
    @Override
    public CollisionBox fetch(VoidPlayer player, ClientVersion version, WrappedBlockState block, int x, int y, int z) {
