package ac.voidac.utils.collisions.blocks;
...
public class DynamicStair implements CollisionFactory {
    ...
    public static EnumShape getStairsShape(VoidPlayer player, WrappedBlockState originalStairs, int x, int y, int z) {
    ...
    private static boolean canTakeShape(VoidPlayer player, WrappedBlockState stairOne, int x, int y, int z) {
