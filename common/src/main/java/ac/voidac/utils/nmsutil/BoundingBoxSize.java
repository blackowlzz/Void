...
import ac.voidac.utils.data.packetentity.*;
...
public final class BoundingBoxSize {
    ...
    public static float getWidth(VoidPlayer player, PacketEntity packetEntity) {
    ...
    private static float getWidthMinusBaby(VoidPlayer player, PacketEntity packetEntity) {
    ...
    public static Vector3d getRidingOffsetFromVehicle(PacketEntity entity, VoidPlayer player) {
        ...
        if (entity instanceof PacketEntityTrackXRot xRotEntity) {
            ...
            if (EntityTypes.isTypeInstanceOf(entity.type, EntityTypes.BOAT)) {
                ...
                vec3 = yRot(VoidMath.radians(-xRotEntity.interpYaw) - ((float) Math.PI / 2f), vec3);
                return new Vector3d(x + vec3.x, y + (double) f1, z + vec3.z);
            } else if (entity.type == EntityTypes.LLAMA) {
                float f = player.trigHandler.cos(VoidMath.radians(xRotEntity.interpYaw));
                float f1 = player.trigHandler.sin(VoidMath.radians(xRotEntity.interpYaw));
                ...
                float f = player.trigHandler.sin(VoidMath.radians(xRotEntity.interpYaw));
                float f1 = player.trigHandler.cos(VoidMath.radians(xRotEntity.interpYaw));
    ...
    public static float getHeight(VoidPlayer player, PacketEntity packetEntity) {
    ...
    public static double getPassengerRidingOffset(VoidPlayer player, PacketEntity packetEntity) {
    ...
    private static float getHeightMinusBaby(VoidPlayer player, PacketEntity packetEntity) {
        final EntityType type = packetEntity.type;
    ...
    private static float getBabyScaleFactor(VoidPlayer player, PacketEntity packetEntity) {
        final EntityType type = packetEntity.type;
