...
public class Materials {
    ...
    private static final Set<StateType> STORAGE_BLOCKS = new HashSet<>();
    ...
    static {
        ...
        STORAGE_BLOCKS.addAll(CHESTS);
        STORAGE_BLOCKS.add(StateTypes.BARREL);
        STORAGE_BLOCKS.add(StateTypes.ENDER_CHEST);
        STORAGE_BLOCKS.add(StateTypes.HOPPER);
        STORAGE_BLOCKS.addAll(BlockTags.SHULKER_BOXES.getStates());
    ...
    public static Set<StateType> getStorageBlocks() {
        return new HashSet<>(STORAGE_BLOCKS);
    }

    public static Set<StateType> getClientSideBlocks() {
        return new HashSet<>(CLIENT_SIDE);
    }

    public static Set<StateType> getAntiEspBlocks() {
        return getAntiEspBlocks(false);
    }

    public static Set<StateType> getAntiEspBlocks(boolean includeClientSideBlocks) {
        Set<StateType> blocks = new HashSet<>(STORAGE_BLOCKS);
        if (includeClientSideBlocks) {
            blocks.addAll(CLIENT_SIDE);
        }
        return blocks;
    }

    public static boolean isStorageBlock(StateType type) {
        return STORAGE_BLOCKS.contains(type);
    }
