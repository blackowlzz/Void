...
public class Ray implements Cloneable {
    ...
    public Ray(VoidPlayer player, double x, double y, double z, float xRot, float yRot) {
    ...
    public static Vector3dm calculateDirection(VoidPlayer player, float xRot, float yRot) {
