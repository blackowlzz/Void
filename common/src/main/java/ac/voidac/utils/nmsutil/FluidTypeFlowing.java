...
public class FluidTypeFlowing {
        ...
        for (BlockFace enumdirection : new BlockFace[]{BlockFace.NORTH, BlockFace.EAST, BlockFace.SOUTH, BlockFace.WEST}) {
            ...
            if (affectsFlow(player, originalX, originalY, originalZ, modifiedX, originalY, modifiedZ)) {
                ...
                if (f == 0.0F) {
                    ...
                    // Void's definition of solid is whether the block has a hitbox
    ...
    private static boolean isSolidFace(VoidPlayer player, int originalX, int y, int originalZ, BlockFace direction) {
    ...
    public static boolean isSame(VoidPlayer player, int x1, int y1, int z1, int x2, int y2, int z2) {
