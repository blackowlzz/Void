...
public enum MenuType {
    ...
    public static AbstractContainerMenu getMenuFromID(VoidPlayer player, Inventory playerInventory, MenuType type) {
        return switch (type) {
    ...
    public static AbstractContainerMenu getMenuFromString(VoidPlayer player, Inventory inventory, String legacyType, int slots, int horse) {
