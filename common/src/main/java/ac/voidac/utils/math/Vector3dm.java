...
public class Vector3dm implements Cloneable, Serializable {
    ...
    public double length() {
        return Math.sqrt(VoidMath.square(this.x) + VoidMath.square(this.y) + VoidMath.square(this.z));
    }

    public double lengthSquared() {
        return VoidMath.square(this.x) + VoidMath.square(this.y) + VoidMath.square(this.z);
    }
    ...
    public double distanceSquared(double oX, double oY, double oZ) {
        return VoidMath.square(this.x - oX) + VoidMath.square(this.y - oY) + VoidMath.square(this.z - oZ);
    }
    ...
    public boolean isInSphere(@NotNull Vector3dm origin, double radius) {
        return VoidMath.square(origin.x - this.x) + VoidMath.square(origin.y - this.y) + VoidMath.square(origin.z - this.z) <= VoidMath.square(radius);
    }
    ...
    public int getBlockX() {
        return VoidMath.mojangFloor(this.x);
    }
    ...
    public int getBlockY() {
        return VoidMath.mojangFloor(this.y);
    }
    ...
    public int getBlockZ() {
        return VoidMath.mojangFloor(this.z);
    }
