...
public class PacketEntityHorse extends PacketEntityTrackXRot implements JumpableEntity {
    ...
    public PacketEntityHorse(VoidPlayer player, UUID uuid, EntityType type, double x, double y, double z, float xRot) {
    ...
    @Override
    public boolean canPlayerJump(VoidPlayer player) {
        return this.hasSaddle();
    }

    @Override
    public void executeJump(VoidPlayer player, Set<VectorData> possibleVectors) {
