package ac.voidac.utils.data.packetentity.dragon;
...
public final class PacketEntityEnderDragonPart extends PacketEntity {
    ...
    public PacketEntityEnderDragonPart(VoidPlayer player, DragonPart part, double x, double y, double z, float width, float height) {
