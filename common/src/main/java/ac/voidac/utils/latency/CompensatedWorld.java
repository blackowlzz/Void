...
import ac.voidac.utils.data.BlockPrediction;
import ac.voidac.utils.data.Pair;
import ac.voidac.utils.data.PistonData;
import ac.voidac.utils.data.ShulkerData;
import ac.voidac.utils.data.packetentity.PacketEntity;
import ac.voidac.utils.data.packetentity.PacketEntityShulker;
...
public class CompensatedWorld implements PacketWorld {
    ...
    public CompensatedWorld(VoidPlayer player) {
        this.player = player;
    ...
    public double getWaterFluidLevelAt(double x, double y, double z) {
        return getWaterFluidLevelAt(VoidMath.floor(x), VoidMath.floor(y), VoidMath.floor(z));
    }
