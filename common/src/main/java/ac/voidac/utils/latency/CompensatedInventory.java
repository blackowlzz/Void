...
import ac.voidac.utils.inventory.EquipmentType;
import ac.voidac.utils.inventory.Inventory;
import ac.voidac.utils.inventory.inventory.AbstractContainerMenu;
import ac.voidac.utils.inventory.inventory.MenuType;
import ac.voidac.utils.inventory.inventory.NotImplementedMenu;
import ac.voidac.utils.lists.CorrectingPlayerInventoryStorage;
...
public class CompensatedInventory extends Check implements PacketCheck {
    ...
    public CompensatedInventory(VoidPlayer playerData) {
        super(playerData);
