...
import ac.voidac.utils.data.packetentity.dragon.PacketEntityEnderDragon;
import ac.voidac.utils.nmsutil.BoundingBoxSize;
import ac.voidac.utils.nmsutil.WatchableIndexUtil;
...
public class CompensatedEntities {
    ...
    public CompensatedEntities(VoidPlayer player) {
        this.player = player;
