package ac.voidac.internal.storage.copy;
...
public final class BackendToBackendCopier {
     ...
     * {@link ac.voidac.internal.storage.backend.sqlite.SqliteBackend}
     * answers via a direct JDBC {@code SELECT uuid FROM void_players};
     * {@link ac.voidac.internal.storage.backend.memory.InMemoryBackend}
    ...
    private Set<UUID> collectPlayersBySessionWalk() throws BackendException {
        ...
        if (src instanceof ac.voidac.internal.storage.backend.sqlite.SqliteBackend sq) {
        ...
        if (src instanceof ac.voidac.internal.storage.backend.memory.InMemoryBackend mem) {
            ...
            synchronized (sq.writeMutexForCopier()) {
                ...
                try {
                    ...
                    try (java.sql.Statement s = conn.createStatement()) {
                        ac.voidac.api.storage.config.TableNames t = sq.tableNames();
