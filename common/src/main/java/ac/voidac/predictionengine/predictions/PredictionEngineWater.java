...
public class PredictionEngineWater extends PredictionEngine {
    ...
    public static void staticVectorEndOfTick(VoidPlayer player, Vector3dm vector, float swimmingFriction, double playerGravity, boolean isFalling) {
    ...
    public static Set<VectorData> transformSwimmingVectors(VoidPlayer player, Set<VectorData> base) {
    ...
    public void guessBestMovement(float swimmingSpeed, VoidPlayer player, boolean isFalling, double playerGravity, float swimmingFriction) {
    ...
    @Override
    public void endOfTick(VoidPlayer player, double playerGravity) {
