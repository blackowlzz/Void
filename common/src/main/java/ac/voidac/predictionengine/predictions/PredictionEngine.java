package ac.voidac.predictionengine.predictions;
...
import ac.voidac.utils.nmsutil.Riptide;
...
public class PredictionEngine {
    ...
    public static Vector3dm clampMovementToHardBorder(VoidPlayer player, Vector3dm outputVel) {
        // TODO: Reimplement
        return outputVel;
    }

    public static Vector3dm transformInputsToVector(VoidPlayer player, Vector3dm theoreticalInput) {
    ...
    public static Vec2 modifyInput(VoidPlayer player, Vec2 moveVector) {
    ...
    private static float distanceToUnitSquare(Vec2 input) {
        ...
        return VoidMath.sqrt(1.0F + VoidMath.square(additional));
    }
    ...
    private static float getItemUseSpeedMultiplier(VoidPlayer player) {
    ...
    public void guessBestMovement(float speed, VoidPlayer player) {
    ...
    private void addZeroPointThreeToPossibilities(float speed, VoidPlayer player, List<VectorData> possibleVelocities) {
    ...
    public void addFluidPushingToStartingVectors(VoidPlayer player, Set<VectorData> data) {
    ...
    public Set<VectorData> fetchPossibleStartTickVectors(VoidPlayer player) {
        ...
        // Inputs are done AFTER fluid pushing, https://github.com/MWHunter/Void/issues/660
    ...
    private void addNonEffectiveAI(VoidPlayer player, Set<VectorData> data) {
    ...
    private void addAttackSlowToPossibilities(VoidPlayer player, Set<VectorData> velocities) {
    ...
    public void applyMovementThreshold(VoidPlayer player, Set<VectorData> velocities) {
    ...
    public void addExplosionToPossibilities(VoidPlayer player, Set<VectorData> existingVelocities) {
    ...
    public int sortVectorData(VectorData a, VectorData b, VoidPlayer player) {
        int aScore = 0;
        int bScore = 0;
    ...
    public Vector3dm handleStartingVelocityUncertainty(VoidPlayer player, VectorData vector, Vector3dm targetVec) {
        ...
        // https://github.com/MWHunter/Void/issues/398
        ...
        //
        //
        // Void's old solution with hard lerping entities was to just give a ton of direct offset reduction
    ...
    public void endOfTick(VoidPlayer player, double d) {
    ...
    public boolean canSwimHop(VoidPlayer player) {
    ...
    public Vector3dm getMovementResultFromInput(VoidPlayer player, Vector3dm inputVector, float f, float f2) {
        float f2InRadians = VoidMath.radians(f2);
    ...
    public Vector3dm handleOnClimbable(Vector3dm vector, VoidPlayer player) {
        return vector;
    }

    public void doJump(VoidPlayer player, Vector3dm vector) {
