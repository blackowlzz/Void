...
public class PredictionEngineElytra extends PredictionEngine {
    public static Vector3dm getElytraMovement(VoidPlayer player, Vector3dm vector, Vector3dm lookVector) {
        float pitchRadians = VoidMath.radians(player.pitch);
        ...
        // Yeah, slow falling needs a refactor in void.
