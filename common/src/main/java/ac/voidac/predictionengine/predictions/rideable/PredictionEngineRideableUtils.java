...
import ac.voidac.utils.data.packetentity.JumpableEntity;
...
public final class PredictionEngineRideableUtils {
    ...
    public static Set<VectorData> handleJumps(VoidPlayer player, Set<VectorData> possibleVectors) {
    ...
    public static List<VectorData> applyInputsToVelocityPossibilities(Vector3dm movementVector, VoidPlayer player, Set<VectorData> possibleVectors, float speed) {
        return applyInputsToVelocityPossibilities(new PredictionEngine(), movementVector, player, possibleVectors, speed);
    }

    public static List<VectorData> applyInputsToVelocityPossibilities(PredictionEngine predictionEngine, Vector3dm movementVector, VoidPlayer player, Set<VectorData> possibleVectors, float speed) {
    ...
    public static void applyPendingJumps(VoidPlayer player) {
