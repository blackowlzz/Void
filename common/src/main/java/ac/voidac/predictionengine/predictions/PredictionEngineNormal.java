...
public class PredictionEngineNormal extends PredictionEngine {
    ...
    public static void staticVectorEndOfTick(VoidPlayer player, Vector3dm vector) {
    ...
    public Vector3dm handleOnClimbable(Vector3dm vector, VoidPlayer player) {
        if (player.isClimbing) {
            ...
            vector.setX(VoidMath.clamp(vector.getX(), -0.15F, 0.15F));
            vector.setZ(VoidMath.clamp(vector.getZ(), -0.15F, 0.15F));
