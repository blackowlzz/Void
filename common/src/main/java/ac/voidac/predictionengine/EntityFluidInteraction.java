...
public class EntityFluidInteraction {
    ...
    public void update(final VoidPlayer player, final boolean ignoreCurrent) {
        ...
        int minX = VoidMath.floor(aabb.minX);
        int minY = VoidMath.floor(aabb.minY);
        int minZ = VoidMath.floor(aabb.minZ);
        int maxX = VoidMath.ceil(aabb.maxX) - 1;
        int maxY = VoidMath.ceil(aabb.maxY) - 1;
        int maxZ = VoidMath.ceil(aabb.maxZ) - 1;
        ...
        int playerX = VoidMath.floor(player.lastX);
        double playerEyeY = player.lastY + player.getEyeHeight() - 0.1111111119389534D;
        int playerZ = VoidMath.floor(player.lastZ);
    ...
    public void applyCurrentTo(final FluidTag fluid, final VoidPlayer entity, final double scale) {
    ...
    private static class Tracker {
        ...
        public void applyCurrentTo(final VoidPlayer player, final double scale) {
