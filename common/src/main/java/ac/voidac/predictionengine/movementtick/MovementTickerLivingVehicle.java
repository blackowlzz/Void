...
import ac.voidac.predictionengine.predictions.rideable.PredictionEngineRideableLava;
import ac.voidac.predictionengine.predictions.rideable.PredictionEngineRideableNormal;
import ac.voidac.predictionengine.predictions.rideable.PredictionEngineRideableWater;
import ac.voidac.predictionengine.predictions.rideable.PredictionEngineRideableWaterLegacy;
...
public class MovementTickerLivingVehicle extends MovementTicker {
    ...
    public MovementTickerLivingVehicle(VoidPlayer player) {
        super(player);
    }
