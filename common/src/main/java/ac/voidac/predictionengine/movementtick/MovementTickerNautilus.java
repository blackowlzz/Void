...
import ac.voidac.predictionengine.predictions.rideable.PredictionEngineNautilusWater;
...
public class MovementTickerNautilus extends MovementTickerLivingVehicle {
    ...
    public MovementTickerNautilus(VoidPlayer player) {
        super(player);
    ...
    public float getRiddenSpeed(VoidPlayer player) {
        PacketEntityNautilus nautilus = (PacketEntityNautilus) player.compensatedEntities.self.getRiding();
