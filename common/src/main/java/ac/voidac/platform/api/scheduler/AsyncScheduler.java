...
public interface AsyncScheduler {
     ...
     */
    TaskHandle runNow(@NotNull VoidPlugin plugin, @NotNull Runnable task);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runDelayed(@NotNull VoidPlugin plugin, @NotNull Runnable task, long delay, @NotNull TimeUnit timeUnit);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runAtFixedRate(@NotNull VoidPlugin plugin, @NotNull Runnable task, long delay, long period, @NotNull TimeUnit timeUnit);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runAtFixedRate(@NotNull VoidPlugin plugin, @NotNull Runnable task, long initialDelayTicks, long periodTicks);
     ...
     */
    void cancel(@NotNull VoidPlugin plugin);
}
