...
public interface EntityScheduler {
     ...
     */
    void execute(@NotNull VoidEntity entity, @NotNull VoidPlugin plugin, @NotNull Runnable run, @Nullable Runnable retired, long delay);
     ...
     */
    TaskHandle run(@NotNull VoidEntity entity, @NotNull VoidPlugin plugin, @NotNull Runnable task, @Nullable Runnable retired);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runDelayed(@NotNull VoidEntity entity, @NotNull VoidPlugin plugin, @NotNull Runnable task, @Nullable Runnable retired, long delayTicks);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runAtFixedRate(@NotNull VoidEntity entity, @NotNull VoidPlugin plugin, @NotNull Runnable task, @Nullable Runnable retired, long initialDelayTicks, long periodTicks);
}
