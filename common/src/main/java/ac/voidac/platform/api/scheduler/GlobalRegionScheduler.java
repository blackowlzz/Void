...
public interface GlobalRegionScheduler {
     ...
     */
    void execute(@NotNull VoidPlugin plugin, @NotNull Runnable task);
     ...
     */
    TaskHandle run(@NotNull VoidPlugin plugin, @NotNull Runnable task);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runDelayed(@NotNull VoidPlugin plugin, @NotNull Runnable task, long delay);
