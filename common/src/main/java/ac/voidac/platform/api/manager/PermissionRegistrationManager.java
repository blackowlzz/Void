...
public interface PermissionRegistrationManager {
     ...
     * dynamic permissions (e.g., check-specific permissions like "void.exempt.checkname")
     * are available for autocomplete before Void attempts to use them. This is
     ...
     *
     * @param name         The permission node to register (e.g., "void.exempt").
