...
@CheckData(name = "AirLiquidBreak", stableKey = "void.breaking.air_liquid_break", description = "Breaking a block that cannot be broken")
public class AirLiquidBreak extends Check implements BlockBreakCheck {
    ...
    public AirLiquidBreak(VoidPlayer player) {
        super(player);
    }
    ...
    public void onBlockBreak(BlockBreak blockBreak) {
        ...
        int newTick = VoidAPI.INSTANCE.getTickManager().currentTick;
        if (lastTick == newTick
