...
@CheckData(name = "AirLiquidPlace", stableKey = "void.scaffolding.air_liquid_place", description = "Placed a block against an invalid support")
public class AirLiquidPlace extends BlockPlaceCheck {
    public AirLiquidPlace(VoidPlayer player) {
        super(player);
    }
