...
import static ac.voidac.utils.nmsutil.BlockBreakSpeed.getBlockDamage;

@CheckData(name = "WrongBreak", stableKey = "void.breaking.wrong_break")
public class WrongBreak extends Check implements BlockBreakCheck {
    ...
    public WrongBreak(final VoidPlayer player) {
        super(player);
    }
