...
@CheckData(name = "BadPacketsM", stableKey = "void.badpackets.respawn_alive", description = "Tried to respawn while alive", experimental = true)
public class BadPacketsM extends Check implements PacketCheck {
    public BadPacketsM(final VoidPlayer player) {
        super(player);
    }
