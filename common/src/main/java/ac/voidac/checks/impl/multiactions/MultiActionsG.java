...
@CheckData(name = "MultiActionsG", stableKey = "void.multiactions.action_while_rowing", description = "Attacking or using items while rowing a boat", experimental = true)
public class MultiActionsG extends BlockPlaceCheck {
    public MultiActionsG(VoidPlayer player) {
        super(player);
    }
