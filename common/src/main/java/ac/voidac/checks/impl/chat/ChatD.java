...
@CheckData(name = "ChatD", stableKey = "void.exploit.chat_while_hidden", description = "Chatting while chat is hidden", experimental = true)
public class ChatD extends Check implements PacketCheck {
    private boolean hidden;

    public ChatD(VoidPlayer player) {
        super(player);
    }
