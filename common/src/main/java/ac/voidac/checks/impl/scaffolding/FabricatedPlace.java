...
@CheckData(name = "FabricatedPlace", stableKey = "void.scaffolding.fabricated_place", description = "Sent out of bounds cursor position")
public class FabricatedPlace extends BlockPlaceCheck {
    ...
    public FabricatedPlace(VoidPlayer player) {
        super(player);
    }
