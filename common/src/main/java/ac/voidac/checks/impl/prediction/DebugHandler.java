package ac.voidac.checks.impl.prediction;

import ac.voidac.VoidAPI;
import ac.voidac.checks.debug.AbstractDebugHandler;
...
public class DebugHandler extends AbstractDebugHandler implements PostPredictionCheck {
    ...
    private final Set<VoidPlayer> listeners = new CopyOnWriteArraySet<>(new HashSet<>());
    ...
    public DebugHandler(VoidPlayer player) {
        super(player);
    }
    ...
    public void onPredictionComplete(final PredictionComplete predictionComplete) {
        ...
        for (VoidPlayer listener : listeners) {
        ...
        if (outputToConsole) {
            Sender consoleSender = VoidAPI.INSTANCE.getPlatformServer().getConsoleSender();
    ...
    @Override
    public void toggleListener(VoidPlayer player) {
