package ac.voidac.checks.impl.velocity;
...
@CheckData(name = "AntiKB", stableKey = "void.velocity.anti_knockback", alternativeName = "AntiKnockback", configName = "Knockback", setback = 10, decay = 0.025)
public class KnockbackHandler extends Check implements PostPredictionCheck {
    ...
    public KnockbackHandler(VoidPlayer player) {
        super(player);
    }
