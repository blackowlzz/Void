...
@CheckData(name = "Simulation", stableKey = "void.prediction.simulation", decay = 0.02)
public class OffsetHandler extends Check implements PostPredictionCheck {
    ...
    private static final CompletePredictionEvent.Channel COMPLETE_CHANNEL = VoidAPI.INSTANCE.getEventBus().get(CompletePredictionEvent.class);

    public OffsetHandler(VoidPlayer player) {
        super(player);
    }
