...
@CheckData(name = "MultiPlace", stableKey = "void.scaffolding.multi_place", description = "Placed multiple blocks in a tick", experimental = true)
public class MultiPlace extends BlockPlaceCheck {
    ...
    public MultiPlace(VoidPlayer player) {
        super(player);
    }
