...
@CheckData(name = "RotationPlace", stableKey = "void.scaffolding.rotation_place", description = "Placed a block while not looking at it")
public class RotationPlace extends BlockPlaceCheck {
    ...
    public RotationPlace(VoidPlayer player) {
        super(player);
    }
