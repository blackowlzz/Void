...
@CheckData(name = "BadPacketsC", stableKey = "void.badpackets.wake_not_sleeping", description = "Tried to wake up while not sleeping", experimental = true)
public class BadPacketsC extends Check implements PacketCheck {
    public BadPacketsC(@NotNull VoidPlayer player) {
        super(player);
    }
