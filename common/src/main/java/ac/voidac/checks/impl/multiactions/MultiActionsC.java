...
@CheckData(name = "MultiActionsC", stableKey = "void.multiactions.inventory_click_while_moving", description = "Clicked in inventory while moving")
public class MultiActionsC extends Check implements PacketCheck {
    public MultiActionsC(VoidPlayer player) {
        super(player);
    }

    // TODO: move this to a better spot? not sure where to put this
    @Contract(pure = true)
    public static String getVerbose(@NotNull VoidPlayer player) {
