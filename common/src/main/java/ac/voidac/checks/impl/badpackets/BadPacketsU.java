...
@CheckData(name = "BadPacketsU", stableKey = "void.badpackets.invalid_block_placement", description = "Sent impossible use item packet")
public class BadPacketsU extends Check implements PacketCheck {
    public BadPacketsU(VoidPlayer player) {
        super(player);
    }
