...
@CheckData(name = "VehicleF", stableKey = "void.vehicle.boat_input_mismatch", experimental = true, description = "Sent incorrect boat paddle states")
public class VehicleF extends Check implements PacketCheck {
    public VehicleF(VoidPlayer player) {
        super(player);
    }
