...
import ac.voidac.utils.worldborder.BorderExtent;
import ac.voidac.utils.worldborder.RealTimeMovingBorderExtent;
import ac.voidac.utils.worldborder.StaticBorderExtent;
import ac.voidac.utils.worldborder.TickBasedMovingBorderExtent;
...
public class PacketWorldBorder extends Check implements PacketCheck {
    ...
    public PacketWorldBorder(VoidPlayer playerData) {
        super(playerData);
