...
import ac.voidac.checks.impl.badpackets.BadPacketsW;
...
public class PacketPlayerAttack extends PacketListenerAbstract {
    ...
    private void onAttack(PacketReceiveEvent event, VoidPlayer player, int entityId) {
        if (isInvalidEntity(event, player, entityId)) return;
    ...
    private boolean isInvalidEntity(PacketReceiveEvent event, VoidPlayer player, int entityId) {
