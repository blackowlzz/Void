package ac.voidac.manager.player.handlers;
...
public record DefaultResyncHandler(VoidPlayer player) implements ResyncHandler {

    private static void resyncPositions(VoidPlayer player, int minBlockX, int mY, int minBlockZ, int maxBlockX, int mxY, int maxBlockZ) {
        ...
        VoidAPI.INSTANCE.getScheduler().getRegionScheduler().execute(VoidAPI.INSTANCE.getVoidPlugin(), world,
    ...
    private static void resyncPosition(VoidPlayer player, int x, int y, int z, int sequence) {
        if (player.platformPlayer == null) return;
        ...
        VoidAPI.INSTANCE.getScheduler().getRegionScheduler().execute(VoidAPI.INSTANCE.getVoidPlugin(), world, chunkX, chunkZ, () -> {
