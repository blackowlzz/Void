...
import ac.voidac.checks.impl.aim.AimDuplicateLook;
import ac.voidac.checks.impl.aim.AimModulo360;
import ac.voidac.checks.impl.aim.processor.AimProcessor;
import ac.voidac.checks.impl.badpackets.*;
import ac.voidac.checks.impl.breaking.*;
import ac.voidac.checks.impl.chat.ChatA;
import ac.voidac.checks.impl.chat.ChatB;
import ac.voidac.checks.impl.chat.ChatC;
import ac.voidac.checks.impl.chat.ChatD;
import ac.voidac.checks.impl.combat.*;
import ac.voidac.checks.impl.crash.*;
import ac.voidac.checks.impl.elytra.*;
import ac.voidac.checks.impl.exploit.AutoTotem;
import ac.voidac.checks.impl.exploit.ExploitA;
import ac.voidac.checks.impl.exploit.ExploitB;
import ac.voidac.checks.impl.freecam.AntiSpoofA;
import ac.voidac.checks.impl.freecam.FreecamA;
import ac.voidac.checks.impl.freecam.FreecamB;
import ac.voidac.checks.impl.groundspoof.NoFall;
import ac.voidac.checks.impl.misc.ClientBrand;
import ac.voidac.checks.impl.misc.GhostBlockMitigation;
import ac.voidac.checks.impl.misc.Post;
import ac.voidac.checks.impl.misc.TransactionOrder;
import ac.voidac.checks.impl.movement.NoSlow;
import ac.voidac.checks.impl.movement.PredictionRunner;
import ac.voidac.checks.impl.movement.SetbackBlocker;
import ac.voidac.checks.impl.movement.VehiclePredictionRunner;
import ac.voidac.checks.impl.multiactions.*;
import ac.voidac.checks.impl.packetorder.*;
import ac.voidac.checks.impl.prediction.DebugHandler;
import ac.voidac.checks.impl.prediction.GroundSpoof;
import ac.voidac.checks.impl.prediction.OffsetHandler;
import ac.voidac.checks.impl.prediction.Phase;
import ac.voidac.checks.impl.inventory.InventoryA;
import ac.voidac.checks.impl.inventory.InventoryB;
import ac.voidac.checks.impl.inventory.InventoryC;
import ac.voidac.checks.impl.inventory.InventoryE;
import ac.voidac.checks.impl.inventory.InventoryG;
import ac.voidac.checks.impl.scaffolding.*;
import ac.voidac.checks.impl.sprint.*;
import ac.voidac.checks.impl.timer.*;
import ac.voidac.checks.impl.vehicle.*;
import ac.voidac.checks.impl.velocity.ExplosionHandler;
import ac.voidac.checks.impl.velocity.KnockbackHandler;
import ac.voidac.checks.type.*;
import ac.voidac.events.packets.PacketChangeGameState;
import ac.voidac.events.packets.PacketEntityReplication;
import ac.voidac.events.packets.PacketPlayerAbilities;
import ac.voidac.events.packets.PacketWorldBorder;
import ac.voidac.manager.init.start.SuperDebug;
import ac.voidac.platform.api.permissions.PermissionDefaultValue;
import ac.voidac.player.VoidPlayer;
import ac.voidac.predictionengine.GhostBlockDetector;
import ac.voidac.predictionengine.SneakingEstimator;
import ac.voidac.utils.anticheat.update.*;
import ac.voidac.utils.latency.CompensatedCameraEntity;
import ac.voidac.utils.latency.CompensatedCooldown;
import ac.voidac.utils.latency.CompensatedFireworks;
import ac.voidac.utils.latency.CompensatedInventory;
import ac.voidac.utils.team.TeamHandler;
...
public class CheckManager {
    ...
    public CheckManager(VoidPlayer player) {
...
//                .put(PacketOrderP.class, new PacketOrderP(player))
                ...
                .put(FreecamA.class, new FreecamA(player))
                .put(FreecamB.class, new FreecamB(player))
                .put(AntiSpoofA.class, new AntiSpoofA(player))
    ...
    private void init() {
        ...
        for (final AbstractCheck check : allChecks.values()) {
            ...
            for (String permissionName : permissions) {
                permissionName += id;
                VoidAPI.INSTANCE.getPermissionManager().registerPermission(permissionName, PermissionDefaultValue.FALSE);
            }
        }
    }
}
