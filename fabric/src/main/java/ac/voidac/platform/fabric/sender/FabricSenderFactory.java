package ac.voidac.platform.fabric.sender;
...
public class FabricSenderFactory extends SenderFactory<CommandSourceStack> {
    ...
    private final AbstractFabricPlatformServer platformServer = VoidFabricLoaderPlugin.LOADER.getPlatformServer();
    private final IFabricMessageUtil fabricMessageUtils = VoidFabricLoaderPlugin.LOADER.getFabricMessageUtils();
    ...
    protected void sendMessage(CommandSourceStack sender, Component message) {
        fabricMessageUtils.sendMessage(sender, VoidFabricLoaderPlugin.LOADER.getFabricConversionUtil().toNativeText(message), false);
    }
