package ac.voidac.platform.fabric.utils.convert;
...
//            DynamicRegistryManager registryManager = VoidFabricLoaderPlugin.FABRIC_SERVER.getRegistryManager(); // Replace with actual method to get registry manager
//
