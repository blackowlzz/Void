package ac.voidac.platform.fabric.utils;
    ...
    static {
        ...
        if (HAS_POLYMER) {
            try {
                ...
                System.err.println("[Void] Failed to hook Polymer translation API. Custom blocks may not render correctly or crash client when re-synchronizing.");
                t.printStackTrace();
            }
        }
