package ac.voidac.platform.fabric.mc1205.convert;
...
public class Fabric1205ConversionUtil implements IFabricConversionUtil {
    public ItemStack fromFabricItemStack(net.minecraft.world.item.ItemStack fabricStack) {
        ...
        try {
            ...
            RegistryAccess registryManager = VoidFabricLoaderPlugin.FABRIC_SERVER.registryAccess(); // Replace with actual method to get registry manager
