...
allprojects {
    ...
    repositories {
        ...
        if (project.name == "mc1161") {
            exclusive("https://repo." + "g" + "rim" + ".ac/snapshots") { includeGroup("me.lucko") }
        } else {
    ...
    loom {
        accessWidenerPath = file("src/main/resources/void.accesswidener")
    }
    ...
    publishing.publications.create<MavenPublication>("maven") {
        artifact(tasks.named<AbstractArchiveTask>("remapJar"))
    }
