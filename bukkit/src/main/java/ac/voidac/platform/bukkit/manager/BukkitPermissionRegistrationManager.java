...
public class BukkitPermissionRegistrationManager implements PermissionRegistrationManager {
     ...
     * like "void.exempt.checkname") that are generated at runtime. Most other static permissions
     * (e.g., "void.exempt", "void.alerts.enable-on-join") are registered with their defaults
     ...
     *
     * @param name         The permission node to register (e.g., "void.exempt.checkname").
