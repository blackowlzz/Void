package ac.voidac.platform.bukkit.player;
...
import ac.voidac.platform.bukkit.utils.anticheat.MultiLibUtil;
import ac.voidac.platform.bukkit.utils.convert.BukkitConversionUtils;
import ac.voidac.platform.bukkit.utils.reflection.PaperUtils;
...
public class BukkitPlatformPlayer extends BukkitVoidEntity implements PlatformPlayer {

    private static final BukkitAudiences audiences = BukkitAudiences.create(VoidBukkitLoaderPlugin.LOADER);
    ...
    @Override
    public @Nullable VoidEntity getVehicle() {
        return bukkitPlayer.getVehicle() == null ? null : new BukkitVoidEntity(bukkitPlayer.getVehicle());
    }
    ...
    public void sendPluginMessage(String channelName, byte[] byteArray) {
        this.bukkitPlayer.sendPluginMessage(VoidBukkitLoaderPlugin.LOADER, channelName, byteArray);
    }

    @Override
    public Sender getSender() {
        return VoidBukkitLoaderPlugin.LOADER.getBukkitSenderFactory().map(this.bukkitPlayer);
    }
